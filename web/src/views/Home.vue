                            ...
                            <div class="mx-auto max-w-md px-4 sm:max-w-2xl sm:px-6 sm:text-center lg:px-0 lg:text-left lg:flex lg:items-center">
                                <div class="lg:py-24">
                                    ...
                                    <h1 class="mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                                        <span class="block">
                                            <span class="italic">"The"</span> FOSS Wallet
                                        </span>
                                        <span class=" text-5xl pb-3 block bg-clip-text text-transparent bg-gradient-to-r from-teal-200 to-cyan-400 sm:pb-5">
                                            for Crypto's TOP Builders
                                        </span>
                                    </h1>
                                    <p class="text-base text-gray-300 sm:text-xl lg:text-lg xl:text-xl">
                                        <strong class="text-yellow-500">GIT FORK-N-GO IN UNDER 5 MINUTES!</strong>

                                        Quickly build a functional MVP for ANY blockchain, including: SmartBCH, Avalanche, Solana and more.

                                        Security fixes and feature updates pull from upstream to keep your app's users <strong class="text-pink-500">SAFU &amp; HAPPY.</strong>
                                    </p>
                                    <div class="mt-10 sm:mt-12">
                                        <form action="#" class="sm:max-w-xl sm:mx-auto lg:mx-0">
                                            ...
                                            <p class="mt-3 text-sm text-gray-300 sm:mt-4">
                                                This software is still undergoing initial research, development and testing.
                                                It is NOT currently safe for production use.
                                            </p>
                                        </form>
                                    </div>
                                </div>
